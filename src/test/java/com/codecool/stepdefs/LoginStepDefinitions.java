...
public class LoginStepDefinitions {
    ...
    @Before
    public void setup(){
        System.setProperty("webdriver.chrome.driver", "C:\\Program Files\\Selenium drivers\\chromedriver-win64\\chromedriver.exe");
    ...
    public void i_have_entered_a_valid_username_and_password() {
        loginPage.enterEmail("smith@example.com");
        loginPage.enterPassword("Hello1234!");
    }
